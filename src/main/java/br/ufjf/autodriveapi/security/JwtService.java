...
public class JwtService {
    ...
    public String gerarToken( UsuarioAdmin usuarioAdmin ){
        ...
        return Jwts
                .builder()
                .setSubject(usuarioAdmin.getLogin())
                .setExpiration(data)
    ...
    public String obterLoginUsuarioAdmin(String token) throws ExpiredJwtException{
